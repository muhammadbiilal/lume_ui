...
| `pagehead` | width | 390.00 | 390.00 | = |  |
| `pagehead` | height | 67.00 | 67.00 | = |  |
| `pagehead.saved` | y | 12.00 | 12.00 | = |  |
| `pagehead.saved` | x | 332.00 | 332.00 | = |  |
| `pagehead.saved` | width | 38.00 | 38.00 | = |  |
| `pagehead.saved` | height | 38.00 | 38.00 | = |  |
| `railsearch` | y | 85.00 | 85.00 | = |  |
| `railsearch` | x | 20.00 | 20.00 | = |  |
| `railsearch` | width | 350.00 | 350.00 | = |  |
| `railsearch` | height | 193.00 | 193.00 | = |  |
| `railfield` | y | 102.00 | 102.00 | = |  |
| `railfield` | x | 55.00 | 55.00 | = |  |
| `railfield` | width | 254.00 | 254.00 | = |  |
| `railfield` | height | 48.00 | 48.00 | = |  |
| `railswap` | y | 136.00 | 136.00 | = |  |
| `railswap` | x | 320.00 | 320.00 | = |  |
| `railswap` | width | 34.00 | 34.00 | = |  |
| `railswap` | height | 34.00 | 34.00 | = |  |
| `railchip` | y | 223.50 | 223.50 | = |  |
...
| `livetrain` | height | 136.00 | 134.00 | -2.00 | cumulative line-box rounding (D20) |

### Trains · Muslim, Pakistan — the lower half

| element | axis | prototype | Flutter | Δ | note |
|---|---|---|---|---|---|
| `trainlist` | y | 566.00 | 564.00 | -2.00 | cumulative line-box rounding (D20) |
| `trainlist` | x | 20.00 | 20.00 | = | cumulative line-box rounding (D20) |
| `trainlist` | width | 350.00 | 350.00 | = | cumulative line-box rounding (D20) |
| `trainlist` | height | 306.00 | 306.00 | = | cumulative line-box rounding (D20) |
| `train.row` | y | 567.00 | 565.00 | -2.00 | the prototype measures inside the list card's 1-point border |
| `train.row` | width | 348.00 | 348.00 | = | the prototype measures inside the list card's 1-point border |
| `train.row` | height | 61.00 | 61.00 | = | the prototype measures inside the list card's 1-point border |
| `routecard` | y | 950.00 | 948.00 | -2.00 | cumulative line-box rounding (D20) |
| `routecard` | x | 20.00 | 20.00 | = | cumulative line-box rounding (D20) |
| `routecard` | width | 152.00 | 152.00 | = | cumulative line-box rounding (D20) |
| `routecard` | height | 89.00 | 89.00 | = | cumulative line-box rounding (D20) |
