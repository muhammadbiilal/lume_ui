...
const TOOL_TARGETS = {
  ...
  // Rollout wave 2 — To-dos' and Shopping's checkable rows, Notes' pinned
  // cards, To-dos' two filter groups, and the records' bulk clear.
  'fgroup1': '#toolBody .filterbar__group:nth-child(1)',
  'fgroup2': '#toolBody .filterbar__group:nth-child(2)',
  'fgroup2.chip1': '#toolBody .filterbar__group:nth-child(2) .fchip:nth-child(1)',
  'taskrow1': '#toolBody .rows > .taskrow:nth-child(1)',
  'taskrow2': '#toolBody .rows > .taskrow:nth-child(2)',
  'taskrow.box': '#toolBody .taskrow__box',
  'taskrow.label': '#toolBody .taskrow__label',
  'taskrow.meta': '#toolBody .taskrow__meta',
  'taskrow.value': '#toolBody .taskrow__value',
  'taskrow.badge': '#toolBody .taskrow .badge',
  'notecard1': '#toolBody .hstrip > .notecardx:nth-child(1)',
  'notecard2': '#toolBody .hstrip > .notecardx:nth-child(2)',
  'notecard.title': '#toolBody .notecardx__title',
  'notecard.body': '#toolBody .notecardx__body',
  'notecard.meta': '#toolBody .notecardx__meta',
  'cbulk': '#toolBody .cbulk',
  'cbulk.btn': '#toolBody .cbulk .btn',
  'rrec.check': '#toolBody .rrec__check',
  'rrec.badge': '#toolBody .rrec .badge',
  'rrec.meta': '#toolBody .rrec__meta',
