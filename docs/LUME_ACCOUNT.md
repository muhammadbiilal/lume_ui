...
| route | manifest | reachable | back | protected | bounds | golden | composition | form | validation | dirty guard | destructive | session state | writes | empty/slow | a11y |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `prefs` | R | A | A | — | B | G | P | — | — | F | — | — | — | — | A |
| `language` | R | A | A | — | B | G | P | — | — | F | — | — | P | — | A |
| `region` | R | A | A | — | B | G | P | — | — | F | — | — | P† | P | A |
| `currency` | R | A | A | — | B | G | P | — | — | F | — | — | P | — | A |
| `units` | R | A | A | — | B | G | P | — | — | F | — | — | P | — | A |
| `time` | R | A | A | — | B | G | P | — | — | F | — | — | P | — | A |
| `appearance` | R | A | A | — | B | G | P | — | — | F | — | — | P | — | A |
| `notifications` | R | A | A | — | B | G | N | — | — | F | — | N | N | N | N |
| `library` | R | A | A | — | B | G | T | — | — | F | — | — | — | T | T |
| `account` | R | A | A | R A | B | G | I | — | — | F | I | I | — | — | I |
| `edit` | R | A | A | R A | B | G | F | F | F | F | — | F | F | F | F |
| `email` | R | A | A | R A | B | G | F | F | F | F | — | F | F | F | F |
| `phone` | R | A | A | R A | B | G | F | F | F | F | — | F | F | F | F |
| `security` | R | A | A | R A | B | G | I | — | — | F | I | I | I | — | I |
| `password` | R | A | A | R A | B | G | F | F | F | F | F | F | F | F | F |
| `sessions` | R | A | A | R A | B | G | D | — | — | F | D | D | D | D | D |
| `privacy` | R | A | A | — | B | G | T | — | — | F | — | T | T | — | A |
| `sync` | R | A | A | — | B | G | T | — | — | F | — | T | — | T | T |
| `help` | R | A | A | — | B | G | T | — | — | F | — | — | T | — | T |
| `about` | R | A | A | — | B | G | T | — | — | F | — | — | — | — | T |
| `delete` | R | A | A | R A | B | G | D | D | D | F | D | D | D | D | D |
...
| routes | 21 |
| protected routes | 7 |
| named behavioural cases | 201 |
| every-route loops (manifest, bounds, reachability, goldens) | 4 × 21 |

The behavioural cases, by file:

| file | cases |
|---|---|
| `account_forms_test.dart` | 41 |
| `account_data_test.dart` | 37 |
| `account_notifications_test.dart` | 25 |
| `account_preferences_test.dart` | 31 |
| `account_identity_test.dart` | 23 |
| `account_destructive_test.dart` | 21 |
| `account_reachability_test.dart` | 12 |
| `account_routes_test.dart` | 11 |
