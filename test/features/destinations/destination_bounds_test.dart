...
void main() {
  ...
  group('Trains is where the prototype puts it', () {
    testWidgets('the head, the search card and the tracked service', (
      WidgetTester tester,
    ) async {
      final Map<String, dynamic>? c = cell('trains_muslim_pk');
      if (c == null) return;
      final Map<String, dynamic> b = c['bounds'] as Map<String, dynamic>;
      ...
      await pumpTrains(tester, LumeUsers.muslimPk, surface: kTall);

      compare(
        tester,
        b,
        'pagehead',
        inKey(LumeTrainsScreen.headKey, find.byType(LumePageHead)),
      );
      compare(
        tester,
        b,
        'pagehead.saved',
        inKey(LumeTrainsScreen.headKey, find.byType(LumeHeaderButton)),
      );
      compare(
        tester,
        b,
        'railsearch',
        inKey(LumeTrainsScreen.searchKey, find.byType(LumeRailSearchCard)),
      );
      ...
      compare(
        ...
        b,
        'livetrain',
        inKey(LumeTrainsScreen.trackedKey, find.byType(LumeCard)),
        tolerance: kDrift,
        note: kDriftNote,
      );
    });

    testWidgets('the departures and the routes', (WidgetTester tester) async {
      final Map<String, dynamic>? c = cell('trains_muslim_pk');
      if (c == null) return;
      final Map<String, dynamic> b = c['bounds'] as Map<String, dynamic>;
      rows.add('\n### Trains · Muslim, Pakistan — the lower half\n');
      rows.add('| element | axis | prototype | Flutter | Δ | note |');
      rows.add('|---|---|---|---|---|---|');
      ...
      compare(
        ...
        b,
        'trainlist',
        inKey(LumeTrainsScreen.departuresKey, find.byType(LumeCard)),
        tolerance: kDrift,
        note: kDriftNote,
      );
      compare(
      ...
      compare(
        ...
        b,
        'routecard',
        find.byType(LumeRouteCard).first,
        tolerance: kDrift,
        note: kDriftNote,
      );
    });
...
# The five destinations, measured
